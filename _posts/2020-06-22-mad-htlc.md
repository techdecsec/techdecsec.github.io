...
HTLC [source](https://btcmanager.com/an-introductory-guide-to-hashed-timelock-contracts/){: .mx-auto.d-block :}
...
Bob offers more money, miners are incentivized to follow.{: .mx-auto.d-block :}
...
Sean Bean is all about game theory.{: .mx-auto.d-block :}
...
MAD in action [source](https://www.tremr.com/chris-barton/mutually-assured-destruction-the-cold-war-theory-keeping-india-and-pakistan-away-from-each-others-throats){: .mx-auto.d-block :}
