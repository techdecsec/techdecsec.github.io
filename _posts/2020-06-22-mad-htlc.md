...
Our [technical report](arxiv) includes the detailed analysis, as well as the MAD-HTLC Bitcoin script, pointers main-net experiments (e.g., [Bob settles](link), [miner takes all](link)), and details on our implementation of a bitcoind patch for generic miner optimization. 
